                ...
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        ...
                        <h3 class="animated fadeInLeft">pengajian</h3>
                    ...
                    <div class="col-md-0 col-sm-12">
                        ...
                        <a class="navbar-brand btn btn-gradient btn-danger" href="{{ url('penggajian/create') }}">
                            tambah
                            <span class="fa  fa-pencil fa-1x"></span>
                        </a>
                      <!--   <a href="{{url('penggajian/create')}}"> <button class=" btn btn-circle btn-gradient btn-danger" > -->
                               <!--  <span class="fa  fa-pencil fa-1x"></span> -->
                              <!-- </button></a> -->

            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/lemburp')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('kode_limbur_id') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <?php if($errors->has('kode_limbur_id')): ?>
                                    <span class="help-block">
                                        <strong><?php echo e($errors->first('kode_limbur_id')); ?></strong>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
